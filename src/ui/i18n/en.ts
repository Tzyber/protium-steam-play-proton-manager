...
export const en = {
  ...
  explain: {
    ...
    topics: {
      ...
      externalCompatdata: {
        ...
        meaning:
          "launch options contain a conservatively recognized STEAM_COMPAT_DATA_PATH pattern",
  ...
  support: {
    ...
    scanCoverage: "Scan coverage: {state} (source: local scan)",
    ...
    launchConfig: "Launch-options source: {status} (source: config)",
    assignmentSource: "Assignment source: {source} (config fact)",
    ...
    footprintComplete: "Known footprint: {size} (source: local measurement and existence check)",
    footprintPartial:
      "Known footprint: {size} (partial; source: local measurement and existence check)",
    footprintNotMeasured:
      "Known footprint: not measured (source: local measurement and existence check)",
    externalCompatdataDetected: "External compatdata hint: detected (source: launch config)",
    externalCompatdataUnknown: "External compatdata hint: unknown (source: launch config)",
    cleanupDisplayedState: "Cleanup: existing displayed state, freshness unknown",
    cleanupCheckInProgress: "Cleanup: check in progress",
    cleanupBlocked: "Cleanup blocked (existing displayed state): {area}",
    ...
    anonymized: "Names and paths are omitted; tools are shown as report-local aliases.",
    unknown: "unknown",
  },
  errors: {
    steamRunning:
