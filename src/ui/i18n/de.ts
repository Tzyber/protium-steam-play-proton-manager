...
export const de = {
  ...
  drawer: {
    ...
    prefixExternal:
      "Prefix-Ordner nicht verfügbar: Startoptionen enthalten STEAM_COMPAT_DATA_PATH. Das Standardziel ist nicht belegt.",
    ...
    prefixNotFound: "Prefix-Ordner nicht gefunden.",
    prefixUnreadable: "Prefix-Ordner oder Installationsbeleg unlesbar.",
    prefixBlocked: "Prefix-Ordner aus Sicherheitsgründen blockiert.",
  ...
  support: {
    ...
    footprintNotMeasured: "Bekannt belegt: nicht gemessen [lokale Messung und Existenzprüfung]",
