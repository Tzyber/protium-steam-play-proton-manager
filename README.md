...
```sh
chmod +x protium_0.4.5_amd64.AppImage
./protium_0.4.5_amd64.AppImage
```
...
```sh
sudo apt install ./protium_0.4.5_amd64.deb
```
...
```sh
./protium_0.4.5_amd64.AppImage --appimage-extract-and-run
```
